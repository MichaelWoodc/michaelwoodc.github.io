...
<p>
Plain text content for image {i} goes here...
</p>
      </div>
      <div class="code-section">
        <textarea rows="4" class="textbox code">
Your code for image {i} goes here...
        </textarea>
...
html_code += """
  ...
  <script>
    ...
    function copyCode(slideNumber) {{
      let codeTextarea = document.querySelectorAll('.code')[slideNumber-1];
      let range = document.createRange();
      range.selectNode(codeTextarea);
